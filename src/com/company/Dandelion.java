...
public class Dandelion extends Plant{
    ...
    private final ImageIcon texture = new ImageIcon("imagesGame/dandelion.jpg");
    public Dandelion()
    {

    }
    public Dandelion(Vector2 coordinates, World world)
    {
        this.initiative = 0;
        this.age = 0;
        this.strength = 0;
        ...
        System.out.println("Dandelion appears");
    }
    public Dandelion (int x, int y, World world, int strength, int age)
    {
        this.initiative = 0;
        this.age = age;
    ...
    public void Breed()
    {
        for (int i = 0; i < 3; i++)
        {
            int dandelionTry = (int)(Math.random()*100);
            if (dandelionTry < 10)
            {
